...
- Công cụ: Git, GitHub, VS Code, MySQL, Visual Studio 
## Kỹ năng đa phương tiện
- Công cụ thành thạo: Adobe Photoshop, Adobe Ilustrator, Adobe After Effect, Adobe Animate, Adobe Premiere, Blender 3D.
- Đồ hoạ: Thiết kế 2D, 3D Modeling, Kỹ thuật quay dựng phim & Hậu kỳ.
